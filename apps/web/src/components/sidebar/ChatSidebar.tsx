  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      role: 'assistant',
      content: 'Hello! I am your IIoT Pipeline Architect. How can I help you design your industrial data flow today?',
      timestamp: new Date(),
    }
  ]);
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      const assistantMsg: Message = {
        ...
        role: 'assistant',
        content: "I'm analyzing your request. Since we're in an industrial context, I'd recommend ensuring your Edge Gateways are using OPC-UA for reliable field connectivity.",
        timestamp: new Date(),
      };
    ...
    <div className="flex flex-col h-full bg-tech-gray">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4 scrollbar-thin">
        {messages.map((msg) => (
          ...
          >
            <div className={`max-w-[90%] p-3 rounded-lg text-[11px] leading-relaxed ${
              msg.role === 'user' 
