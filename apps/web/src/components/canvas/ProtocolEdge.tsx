    ...
    <>
      ...
      <EdgeLabelRenderer>
        {protocol && (
          ...
          >
            <div className={`px-2 py-0.5 rounded shadow-xl font-bold border group relative flex items-center gap-1 transition-transform hover:scale-110 ${
              isStale 
              ...
              <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover:block w-64 p-3 bg-tech-gray border border-industrial-gray rounded shadow-2xl text-[10px] font-normal z-[1001] pointer-events-none backdrop-blur-md bg-opacity-95">
                <div className="text-industrial-gold font-bold mb-1 uppercase tracking-wider">Analysis Recommendation</div>
